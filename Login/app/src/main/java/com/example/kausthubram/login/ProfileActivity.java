...
public class ProfileActivity extends AppCompatActivity {
        ...
        for (Map.Entry<Integer,Project> entry : applied.entrySet()) {
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  ...
                  DatabaseReference toRemove1 = databaseReference.getReference("profiles/"+email+"/applied/"+projToRemove.getid());
                  DatabaseReference toRemove2 = databaseReference.getReference("projects/"+id+"/applied/"+user.getId());

                    Log.d("WaterCooler", "onClick: " + "profiles/"+email+"/applied/"+id);
                    Log.d("WaterCooler", "onClick: " + "projects/"+id+"/applied/"+user.getId());
    ...
    private void loadProfiles(){
        ...
        getAuthored.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
